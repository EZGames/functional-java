 ...
 */
class ParameterlessSwitchExpression<R> extends SwitchExpression<Callable<Boolean>, R>
{
	//***************************************************************************
	// Public API methods
	//***************************************************************************
	public ParameterlessCase<R> case_(Callable<Boolean> expr)
	{
